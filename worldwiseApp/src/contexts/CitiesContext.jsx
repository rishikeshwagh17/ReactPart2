...
//adding the reducer to make code more readable so we can use context api with reducer
function reducer(state, action) {
  //always consider the naming convention as like you are doing action is for event handler and not as setters
  //example it shouldnt be setCities
  switch (action.type) {
    case "loading":
      return {
        ...state,
